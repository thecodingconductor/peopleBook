...
export const FILTER_FILTERED_CONTACTS = 'FILTER_FILTERED_CONTACTS';
export const CLEAR_FILTERED_BY_ORG = 'CLEAR_FILTERED_BY_ORG';
...
export const REMOVE_VIP = "REMOVE_VIP";
export const REMOVE_VIP_ERROR = "REMOVE_VIP_ERROR";
...
export const CLEAR_VIP = "CLEAR_VIP";
export const CLEAR_URGENT_ITEM = "CLEAR_URGENT_ITEM";
